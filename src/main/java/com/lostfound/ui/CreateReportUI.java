...
public class CreateReportUI extends JFrame {
    ...
    private static final Border BORDER_FOCUSED = BorderFactory.createCompoundBorder(
            ...
            new EmptyBorder(9, 14, 9, 14) // Adjust padding
    );
    ...
    public CreateReportUI() {
        ...
        setTitle("Create Report - Tracify");
        setSize(600, 800);
        ...
        txtDescription.setBorder(BORDER_DEFAULT); // Use default border
        ...
        // Add Focus Listener for Description
        txtDescription.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent e) {
                txtDescription.setBorder(BORDER_FOCUSED);
            }
            @Override
            public void focusLost(FocusEvent e) {
                txtDescription.setBorder(BORDER_DEFAULT);
            }
        });
        ...
        // --- Added Scroll Pane for the whole form ---
    ...
    // --- Updated createFormField to add FocusListener ---
    private JPanel createFormField(String labelText, JTextField textField) {
        ...
        textField.setBorder(BORDER_DEFAULT); // Use default border
        ...
        // Add Focus Listener for hover/focus effect
