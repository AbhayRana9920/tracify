...
public class HomeUI extends JFrame {
    ...
    private static final Border BORDER_FOCUSED = BorderFactory.createCompoundBorder(
            ...
            new EmptyBorder(4, 9, 4, 9) // Adjust padding
    );
    ...
    public HomeUI() throws SQLException {
        ...
        searchField.setBorder(BORDER_DEFAULT); // Use default border
        ...
        searchField.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                searchField.setBorder(BORDER_FOCUSED);
            }
            @Override
            public void focusLost(FocusEvent e) {
                searchField.setBorder(BORDER_DEFAULT);
            }
        });
