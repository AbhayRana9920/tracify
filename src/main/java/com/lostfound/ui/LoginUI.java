...
public class LoginUI extends JFrame {
    ...
    public LoginUI() throws SQLException {
        ...
        emailField.setBorder(BORDER_DEFAULT); // Use default border
        ...
        passwordField.setBorder(BORDER_DEFAULT); // Use default border
        ...
        emailField.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent e) {
                emailField.setBorder(BORDER_FOCUSED);
            }
            @Override
            public void focusLost(FocusEvent e) {
                emailField.setBorder(BORDER_DEFAULT);
            }
        });
        ...
        passwordField.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent e) {
                passwordField.setBorder(BORDER_FOCUSED);
            }
            @Override
            public void focusLost(FocusEvent e) {
                passwordField.setBorder(BORDER_DEFAULT);
            }
        });
