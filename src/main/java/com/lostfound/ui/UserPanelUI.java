...
public class UserPanelUI extends JFrame {
    ...
    public UserPanelUI() throws SQLException {
        setTitle("Tracify - User Dashboard");
        setSize(700, 600);
        ...
        JLabel footerLabel = new JLabel("Tracify • v1.0");
